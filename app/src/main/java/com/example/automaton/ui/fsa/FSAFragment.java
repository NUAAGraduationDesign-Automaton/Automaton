...
public class FSAFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final TextView textView = root.findViewById(R.id.text_fsa_title);
        FSAViewModel.getText().observe(this, new Observer<String>() {
            @Override
